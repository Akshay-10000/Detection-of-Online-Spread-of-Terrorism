...
class Startpage(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        img=ImageTk.PhotoImage(Image.open(r'E:\Detect_Online_Spread_Of_Terrorsim\wallpaper.jpg').resize((1200,700)))   # set the home page image
        img.image = img
...
class PageOne(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        j=[]
        f = open(r'E:\Detect_Online_Spread_Of_Terrorsim\keywords.txt')
        for line in f:
            j.append(line.strip())
        f.close()
        d = dict.fromkeys(j,0)
...
class PageTwo(ttk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        ttk.Label(self,text="© Akshay , Aditya , Prashant & Pranav",font=(20)).pack()                        # copyright
...
# set app icon
icon = ImageTk.PhotoImage(Image.open(r'E:\Detect_Online_Spread_Of_Terrorsim\icon.jpg'))
